    ...
    <SEOPageLayout title={TITLE} description={DESCRIPTION} path="/analitika-prodazh">
              ...
              <div className="aspect-video bg-gradient-to-br from-slate-50 to-emerald-50/30 flex items-center justify-center p-8">
                <div className="w-full max-w-sm rounded-xl bg-white border border-slate-200 shadow-lg p-4">
                  <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-100">
                    ...
                    <span className="font-semibold text-slate-900">Аналитика продаж</span>
                  </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Какие проблемы решает аналитика продаж в CRM</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Что можно видеть в аналитике 2wix</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Аналитика для руководителя</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Аналитика по менеджерам</h2>
          ...
          <ul className="grid sm:grid-cols-2 gap-4">
            {FOR_MANAGERS_SECTION.map(({ label, icon: Icon }) => (
              <li key={label} className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 text-center mb-14">Данные из CRM автоматически попадают в отчёты — без ручного сбора</p>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Почему это лучше таблиц и ручных отчётов</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Интерфейс аналитики</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Вопросы об аналитике продаж</h2>
          <p className="text-slate-600 text-center mb-14">Частые вопросы об отчётах, воронке и контроле в 2wix</p>
