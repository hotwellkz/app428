...
const DESCRIPTION =
  'Полный обзор возможностей CRM 2wix: клиенты, WhatsApp, сделки, быстрые ответы, аналитика, транзакции, склад, роли и права. Единая система для продаж и операционного управления.';
