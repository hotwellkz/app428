    ...
    <SEOPageLayout title={TITLE} description={DESCRIPTION} path="/crm-dlya-malogo-biznesa">
              ...
              <div className="aspect-video bg-gradient-to-br from-slate-50 to-emerald-50/30 flex items-center justify-center p-8">
                <div className="w-full max-w-sm rounded-xl bg-white border border-slate-200 shadow-lg p-4">
                  <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-100">
                    ...
                    <span className="font-semibold text-slate-900">CRM для малого бизнеса</span>
                  </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Почему малому бизнесу нужна CRM</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Что даёт 2wix малому бизнесу</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Для каких команд подходит</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">2wix не сложный для малого бизнеса</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 text-center mb-14">Простой сценарий: от заявки до результата в одной системе</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Почему 2wix подходит именно для малого бизнеса</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Вопросы о CRM для малого бизнеса</h2>
          <p className="text-slate-600 text-center mb-14">Частые вопросы о 2wix для небольшой компании</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/crm-dlya-biznesa" className="px-5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 font-medium hover:border-emerald-300 hover:bg-emerald-50/50 transition-colors">
              CRM для бизнеса
            </Link>
