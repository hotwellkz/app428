    ...
    <SEOPageLayout title={TITLE} description={DESCRIPTION}>
              ...
              <div className="aspect-video bg-gradient-to-br from-slate-50 to-emerald-50/30 flex items-center justify-center p-8">
                <div className="w-full max-w-sm rounded-xl bg-white border border-slate-200 shadow-lg p-4">
                  <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-100">
                    ...
                    <span className="font-semibold text-slate-900">Сделки</span>
                  </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Какие проблемы решает CRM для продаж</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Что умеет CRM для продаж в 2wix</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 text-center mb-14">От заявки до сделки и отчёта — единый процесс в одной системе</p>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Кому подходит</h2>
          <p className="text-slate-600 text-center mb-12">2wix используют отделы продаж и бизнесы разных отраслей</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 text-center mb-12">Прозрачность отдела продаж без хаоса и «устных отчётов»</p>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Интерфейс CRM для продаж</h2>
          <p className="text-slate-600 text-center mb-14">Сделки, клиенты, WhatsApp и аналитика в одном продукте</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 text-center mb-14">Частые вопросы о CRM для продаж в 2wix</p>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/sdelki-i-voronka" className="px-5 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-700 font-medium hover:border-emerald-300 hover:bg-emerald-50/50 transition-colors">
              Сделки и воронка
            </Link>
