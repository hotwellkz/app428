    ...
    <SEOPageLayout title={TITLE} description={DESCRIPTION} path="/kontrol-menedzherov">
              ...
              <div className="aspect-video bg-gradient-to-br from-slate-50 to-emerald-50/30 flex items-center justify-center p-8">
                <div className="w-full max-w-sm rounded-xl bg-white border border-slate-200 shadow-lg p-4">
                  <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-100">
                    ...
                    <span className="font-semibold text-slate-900">Контроль менеджеров</span>
                  </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Какие проблемы решает контроль менеджеров в CRM</h2>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Что можно контролировать в 2wix</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Контроль переписки и коммуникаций</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
            Вся переписка в одном месте — руководитель видит, кто и как отвечает клиентам. Подробнее о работе с чатами — в разделе <Link to="/whatsapp-crm" className="text-emerald-600 font-medium hover:text-emerald-700">WhatsApp CRM</Link>.
          </p>
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Контроль сделок и этапов</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Чем это полезно руководителю</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 text-center mb-14">От заявок до полной прозрачности по команде — данные в CRM обновляются автоматически</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Почему 2wix лучше ручного контроля</h2>
          <p className="text-lg text-slate-600 text-center max-w-2xl mx-auto mb-14">
      ...
      <section className="py-16 md:py-24 bg-slate-50/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Интерфейс контроля</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Вопросы о контроле менеджеров</h2>
          <p className="text-slate-600 text-center mb-14">Частые вопросы о контроле отдела продаж и работе с командой в 2wix</p>
