/**
 * Публичная дизайн-система 2wix.ru.
 * Используется только на маркетинговых / SEO-страницах. Внутренняя CRM не зависит от этих модулей.
 * @see ./README.md
 */

export { publicTokens } from './theme';
